...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/gsharemedia/VapeV4ForRoblox/main/"..scripturl, true)
	end
end
...
pcall(function()
	whitelisted = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://raw.githubusercontent.com/gsharemedia/whitelists/main/whitelist2.json", true))
end)
			...
			if callback then
				...
				if not suc then
					...
					framebutton1.MouseButton1Click:connect(function()
						spawn(function()
							setclipboard("https://github.com/gsharemedia/VapeV4ForRoblox/wiki/Turning-on-Highlights")
