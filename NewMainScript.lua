...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		local res = game:HttpGet("https://raw.githubusercontent.com/gsharemedia/VapeV4ForRoblox/main/"..scripturl, true)
...
local function checkassetversion()
	local req = requestfunc({
		Url = "https://raw.githubusercontent.com/gsharemedia/VapeV4ForRoblox/main/assetsversion.dat",
		Method = "GET"
	})
...
checkpublicrepo = function(id)
	local suc, req = pcall(function() return requestfunc({
		Url = "https://raw.githubusercontent.com/gsharemedia/VapeV4ForRoblox/main/CustomModules/"..id..".lua",
		Method = "GET"
	}) end)
	if not suc then
...
OnlineProfilesButton.MouseButton1Click:Connect(function()
	...
	if profilesloaded == false then
		...
		local success, result = pcall(function()
			return game:GetService("HttpService"):JSONDecode((shared.VapeDeveloper and readfile("vape/OnlineProfiles.vapeonline") or game:HttpGet("https://raw.githubusercontent.com/gsharemedia/VapeV4ForRoblox/main/OnlineProfiles.vapeonline", true)))
		end)
...
local teleportfunc = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if State == Enum.TeleportState.Started and not shared.VapeIndependent then
		local teleportstr = 'shared.VapeSwitchServers = true if shared.VapeDeveloper then loadstring(readfile("vape/NewMainScript.lua"))() else loadstring(game:HttpGet("https://raw.githubusercontent.com/gsharemedia/VapeV4ForRoblox/main/NewMainScript.lua", true))() end'
		if shared.VapeDeveloper then
